...
@section('content')
<style>
    /* Prevent navbar items from stacking vertically */
        ...
        <div class="container mx-auto px-6">
                ...
                <div class="lg:col-span-3 lg:pt-24">
                    <div class="border-l-2 border-gray-100 pl-6">
                        <p class="text-gray-500 text-lg md:text-xl font-light leading-snug italic">
                            High-energy motion and brand systems developed for <span class="font-bold text-gray-900">Cured Leaves Tea</span>.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-24 pt-10 border-t border-gray-100 grid grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div>
                    ...
                    <p class="text-xs md:text-sm font-bold text-gray-700 uppercase tracking-tight italic">Organic & Bold</p>
                </div>
                <div>
